...
import { AgentPresenceIndicatorComponent } from "./workspace/component/agent-presence-indicator/agent-presence-indicator.component";
...
@NgModule({
  declarations: [
    ...
    AgentPresenceIndicatorComponent,
